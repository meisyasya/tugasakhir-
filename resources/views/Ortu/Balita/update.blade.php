    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="card shadow">
                ...
                <div class="card-body">
                    <!-- Form Edit -->
                    <form action="{{ route('ortu.DataAnakUpdate', $balita->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="tanggal_lahir" name="tanggal_lahir" value="{{ \Carbon\Carbon::parse($balita->tanggal_lahir)->format('d-m-Y') }}" required>
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <br>
                                    <img src="{{ asset($balita->img) }}" alt="Foto Balita" class="img-thumbnail mt-2" width="150">
                                </div>
                            </div>
                        </div>
